...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.nytrotech.color_picker_camera.ColorPickerCameraPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin color_picker_camera, com.nytrotech.color_picker_camera.ColorPickerCameraPlugin", e);
    }
    try {
